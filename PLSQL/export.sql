...
SET DEFINE OFF;
Insert into SERWIS.KOMPUTERY (ID_KOMPUTERA,PRODUCENT,ROK_PRODUKCJI,NR_SERYJNY) values ('22','nowy','2012','2222');
Insert into SERWIS.KOMPUTERY (ID_KOMPUTERA,PRODUCENT,ROK_PRODUKCJI,NR_SERYJNY) values ('16','1111','2000','12345');
Insert into SERWIS.KOMPUTERY (ID_KOMPUTERA,PRODUCENT,ROK_PRODUKCJI,NR_SERYJNY) values ('15','Dell','2015',null);
Insert into SERWIS.KOMPUTERY (ID_KOMPUTERA,PRODUCENT,ROK_PRODUKCJI,NR_SERYJNY) values ('17','producent','2000','1223');
Insert into SERWIS.KOMPUTERY (ID_KOMPUTERA,PRODUCENT,ROK_PRODUKCJI,NR_SERYJNY) values ('21','producent','2000','00005');
REM INSERTING into SERWIS.MAGAZYN
SET DEFINE OFF;
Insert into SERWIS.MAGAZYN (ID_CZESCI,LICZBA_SZTUK) values ('1','48');
Insert into SERWIS.MAGAZYN (ID_CZESCI,LICZBA_SZTUK) values ('2','11');
Insert into SERWIS.MAGAZYN (ID_CZESCI,LICZBA_SZTUK) values ('3','9');
...
SET DEFINE OFF;
Insert into SERWIS.PLATNOSCI (ID_FAKTURY,ID_NAPRAWY,DO_ZAPLATY,ZAPLACONO) values ('459','42','675','0');
...
SET DEFINE OFF;
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('26','1','1','2');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('49','1','21','5');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('44','1','1','2');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('45','100','1','2');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('50','100','21','5');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('43','11','1','2');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('46','1','1','2');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('47','2','1','2');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('48','100','55','5');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('54','1','42','5');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('55','100','42','5');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('56','2','42','5');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('42','100','1','2');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('37','1','55','5');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('36','11','1','1');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('40','100','1','2');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('25','1','1','2');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('41','11','1','2');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('32','1','1','1');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('53','100','41','2');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('51','1','22','2');
Insert into SERWIS.PRACE_NAPRAWCZE (ID_PRACY,ID_USLUGI,ID_NAPRAWY,ID_PRACOWNIKA) values ('52','1','41','2');
REM INSERTING into SERWIS.PRACE_NAPRAWCZE_CZESCI
SET DEFINE OFF;
Insert into SERWIS.PRACE_NAPRAWCZE_CZESCI (ID_PRACY,ID_CZESCI) values ('50','1');
Insert into SERWIS.PRACE_NAPRAWCZE_CZESCI (ID_PRACY,ID_CZESCI) values ('45','2');
Insert into SERWIS.PRACE_NAPRAWCZE_CZESCI (ID_PRACY,ID_CZESCI) values ('45','1');
Insert into SERWIS.PRACE_NAPRAWCZE_CZESCI (ID_PRACY,ID_CZESCI) values (null,'1');
Insert into SERWIS.PRACE_NAPRAWCZE_CZESCI (ID_PRACY,ID_CZESCI) values ('48','1');
Insert into SERWIS.PRACE_NAPRAWCZE_CZESCI (ID_PRACY,ID_CZESCI) values ('55','3');
Insert into SERWIS.PRACE_NAPRAWCZE_CZESCI (ID_PRACY,ID_CZESCI) values ('40','1');
Insert into SERWIS.PRACE_NAPRAWCZE_CZESCI (ID_PRACY,ID_CZESCI) values ('45','2');
Insert into SERWIS.PRACE_NAPRAWCZE_CZESCI (ID_PRACY,ID_CZESCI) values ('45','1');
Insert into SERWIS.PRACE_NAPRAWCZE_CZESCI (ID_PRACY,ID_CZESCI) values ('53','1');
...
SET DEFINE OFF;
Insert into SERWIS.ZAMOWIENIE_NAPRAWY (ID_NAPRAWY,ID_KLIENTA,ID_KOMPUTERA,OPIS_USTERKI,DATA_ROZPOCZECIA,DATA_ZAKONCZENIA,STATUS) values ('42','41','22','test platnosci',to_date('18/01/07','RR/MM/DD'),to_date('18/01/07','RR/MM/DD'),'naprawiony');
Insert into SERWIS.ZAMOWIENIE_NAPRAWY (ID_NAPRAWY,ID_KLIENTA,ID_KOMPUTERA,OPIS_USTERKI,DATA_ROZPOCZECIA,DATA_ZAKONCZENIA,STATUS) values ('21','41','16','aaaaaaaaaaaaa',to_date('18/01/06','RR/MM/DD'),null,'naprawiony');
Insert into SERWIS.ZAMOWIENIE_NAPRAWY (ID_NAPRAWY,ID_KLIENTA,ID_KOMPUTERA,OPIS_USTERKI,DATA_ROZPOCZECIA,DATA_ZAKONCZENIA,STATUS) values ('55','3','15','nowy zepsuty',to_date('01/01/01','RR/MM/DD'),null,'naprawiony');
Insert into SERWIS.ZAMOWIENIE_NAPRAWY (ID_NAPRAWY,ID_KLIENTA,ID_KOMPUTERA,OPIS_USTERKI,DATA_ROZPOCZECIA,DATA_ZAKONCZENIA,STATUS) values ('11','3','15','Zepsuty',to_date('18/01/04','RR/MM/DD'),null,'przyjeto');
Insert into SERWIS.ZAMOWIENIE_NAPRAWY (ID_NAPRAWY,ID_KLIENTA,ID_KOMPUTERA,OPIS_USTERKI,DATA_ROZPOCZECIA,DATA_ZAKONCZENIA,STATUS) values ('1','3','15','Znowu siê zepsól',to_date('18/01/01','RR/MM/DD'),null,'przyjeto');
Insert into SERWIS.ZAMOWIENIE_NAPRAWY (ID_NAPRAWY,ID_KLIENTA,ID_KOMPUTERA,OPIS_USTERKI,DATA_ROZPOCZECIA,DATA_ZAKONCZENIA,STATUS) values ('22','41','17','blablarrgrgegre',to_date('18/01/06','RR/MM/DD'),to_date('18/01/06','RR/MM/DD'),'naprawiony');
Insert into SERWIS.ZAMOWIENIE_NAPRAWY (ID_NAPRAWY,ID_KLIENTA,ID_KOMPUTERA,OPIS_USTERKI,DATA_ROZPOCZECIA,DATA_ZAKONCZENIA,STATUS) values ('41','41','21','niedzialniedziala',to_date('18/01/07','RR/MM/DD'),to_date('18/01/07','RR/MM/DD'),'naprawiony');
--------------------------------------------------------
