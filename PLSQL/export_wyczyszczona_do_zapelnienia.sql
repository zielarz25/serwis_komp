...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SERWIS"."PRACE_NAPRAWCZE_ID_PRACY_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into SERWIS.CENNIK (ID_USLUGI,NAZWA_USLUGI,CENA) values ('101','usluga testowa','1');
...
Insert into SERWIS.MAGAZYN (ID_CZESCI,LICZBA_SZTUK) values ('3','2');
